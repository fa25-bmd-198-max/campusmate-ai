...
// ── Navigation structure (design.md §6.2) ─────────────────────
interface NavItem {
  label: string
  to:    string
      ...
      <div className="flex h-16 shrink-0 items-center gap-2.5 border-b border-gray-200 px-5 dark:border-gray-800">
        ...
        {onClose && (
          <button
            ...
            className="ml-auto rounded-md p-1 text-gray-500 hover:text-gray-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 dark:text-gray-400 dark:hover:text-gray-200"
          >
        ...
        <ul className="space-y-5" role="list">
          {NAV_GROUPS.map((group) => (
            <li key={group.label} role="listitem">
              <p className="mb-1 px-3 text-[11px] font-semibold uppercase tracking-wider text-gray-400 dark:text-gray-600">
                {group.label}
              </p>
      ...
      <div className="shrink-0 border-t border-gray-200 p-3 dark:border-gray-800">
        <div className="flex items-center gap-3 rounded-lg p-2">
          ...
          <button
            ...
            aria-label="Sign out"
            className="shrink-0 rounded-md p-1.5 text-gray-400 hover:text-red-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 dark:text-gray-500 dark:hover:text-red-400"
          >
...
export function DesktopSidebar() {
  return (
    <aside
      className="hidden w-60 shrink-0 border-r border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:flex lg:flex-col"
